    ...
    <section className="latest-products">
      <div className="LatestContainer">
        <div className="section-header ">
         ...
         <p>Discover premium denim crafted for style, comfort, and durability — perfect fits, bold looks, and everyday confidence by Abhinavi Creations.</p>
         </div>
            ...
            {jeansData.map(product => (
              ...
              >
                <div className="product-inner">
                  <Link href={`/Pages/product-details/${product.id}`} className="product-link">
